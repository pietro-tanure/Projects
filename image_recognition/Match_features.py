...
img22 = cv2.imread('../Image_Pairs/torb_small2.png')
print("Dimension de l'image 2 :",img22.shape[0],"lignes x",img22.shape[1],"colonnes")
print("Type de l'image 2 :",img22.dtype)

pts1 = np.float32([[10,50],[150,50],[50,200]])
pts2 = np.float32([[10,120],[200,50],[100,250]])
M = cv2.getAffineTransform(pts1,pts2)
rows,cols,ch = img22.shape
img2 = cv2.warpAffine(img22,M,(cols,rows))
